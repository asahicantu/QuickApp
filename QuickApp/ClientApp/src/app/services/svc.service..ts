...
export class SvcService {
  ...
  get language() {
    return this._language || SvcService.defaultLanguage;
  }
  ...
  get themeId() {
    return this._themeId || SvcService.defaultThemeId;
  }
  ...
  get homeUrl() {
    return this._homeUrl || SvcService.defaultHomeUrl;
  }
  ...
  get showDashboardStatistics() {
    return this._showDashboardStatistics != null ? this._showDashboardStatistics : SvcService.defaultShowDashboardStatistics;
  }
  ...
  get showDashboardNotifications() {
    return this._showDashboardNotifications != null ? this._showDashboardNotifications : SvcService.defaultShowDashboardNotifications;
  }
  ...
  get showDashboardTodo() {
    return this._showDashboardTodo != null ? this._showDashboardTodo : SvcService.defaultShowDashboardTodo;
  }
  ...
  get showDashboardBanner() {
    return this._showDashboardBanner != null ? this._showDashboardBanner : SvcService.defaultShowDashboardBanner;
  }
